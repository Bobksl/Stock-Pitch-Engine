...
1. **`docs/Equity_Research_Framework_v1.4.md`** — the spec. Wins over everything, including
   this file. Check the version header; v1.0 through v1.3 are superseded and their
