...
1. **`docs/Equity_Research_Framework_v1.3.md`** — the spec. Wins over everything, including
   this file. Check the version header; v1.0, v1.1 and v1.2 are superseded and their
